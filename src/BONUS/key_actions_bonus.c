...
/*   Updated: 2024/02/29 13:52:37 by aidgomez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	key_a_moves(t_items *imap)
{
	...
	if (imap->map[imap->pj_pos.y][prev] != '1')
	{
		...
		if (imap->map[imap->pj_pos.y][prev] == 'X')
			game_over(imap);
		else if (imap->map[imap->pj_pos.y][prev] == 'C')
			eating(imap);
...
void	key_d_moves(t_items *imap)
{
	...
	if (imap->map[imap->pj_pos.y][next] != '1')
	{
		...
		if (imap->map[imap->pj_pos.y][next] == 'X')
			game_over(imap);
		else if (imap->map[imap->pj_pos.y][next] == 'C')
			eating(imap);
...
void	key_w_moves(t_items *imap)
{
	...
	if (imap->map[prev][imap->pj_pos.x] != '1')
	{
		...
		if (imap->map[prev][imap->pj_pos.x] == 'X')
			game_over(imap);
		else if (imap->map[prev][imap->pj_pos.x] == 'C')
			eating(imap);
...
void	key_s_moves(t_items *imap)
{
	...
	if (imap->map[next][imap->pj_pos.x] != '1')
	{
		...
		if (imap->map[next][imap->pj_pos.x] == 'X')
			game_over(imap);
		else if (imap->map[next][imap->pj_pos.x] == 'C')
			eating(imap);
